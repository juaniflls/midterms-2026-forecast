...
OFFICIAL_BASELINE_TARGETS = {'DPP': 0.5235678365171035, 'RPP': 0.44723216348289646, 'DHouTiltResH (<=1%)': 1.0, 'DHouTiltResLR (<=1%)': 2.0, 'DHouLeanResH  (>1<=5%)': 10.0, 'DHouLeanResLR  (>1<=5%)': 5.0, 'DHouLikResH (>5%<=10%)': 19.0, 'DHouLikResLR (>5%<=10%)': 1.0, 'DHouSafResH (>5%<=10%)': 177.0, 'DHouSafResLR (>10%)': 0.0, 'RHouTiltResH (<=1%)': 4.0, 'RHouTiltResLD (<=1%)': 3.0, 'RHouLeanResH  (>1<=5%)': 13.0, 'RHouLeanResLD  (>1<=5%)': 4.0, 'RHouLikResH (>5%<=10%)': 15.0, 'RHouLikResLD (>5%<=10%)': 5.0, 'RHouSafResH (>10%)': 172.0, 'RHouSafResLD (>10%)': 4.0, 'DSenTiltResH (<=1%)': 1.0, 'DSenTiltResLR (<=1%)': 0.0, 'DSenLeanResH  (>1<=5%)': 1.0, 'DSenLeanResLR  (>1<=5%)': 0.0, 'DSenLikResH (>5%<=10%)': 1.0, 'DSenLikResLR (>5%<=10%)': 0.0, 'DSenSafResH (>10%)': 10.0, 'DSenSafResLR (>10%)': 0.0, 'RSenTiltResH (<=1%)': 1.0, 'RSenTiltResLD (<=1%)': 1.0, 'RSenLeanResH  (>1<=5%)': 1.0, 'RSenLeanResLD  (>1<=5%)': 1.0, 'RSenLikResH (>5%<=10%)': 2.0, 'RSenLikResLD (>5%<=10%)': 0.0, 'RSenSafResH (>10%)': 15.0, 'RSenSafResLD (>10%)': 1.0}
OFFICIAL_BASELINE_HEADLINE = {'D House Seats': 232, 'R House Seats': 203, 'D Senate Seats': 51, 'R Senate Seats': 49}

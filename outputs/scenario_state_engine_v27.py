"""National counterfactual engine for the Midterms 2026 v27 Scenario Lab.
...
OFFICIAL_BASELINE_TARGETS = {'DPP': 0.5206818961625282, 'RPP': 0.45011810383747175, 'DHouTiltResH (<=1%)': 1.0, 'DHouTiltResLR (<=1%)': 2.0, 'DHouLeanResH  (>1<=5%)': 10.0, 'DHouLeanResLR  (>1<=5%)': 6.0, 'DHouLikResH (>5%<=10%)': 19.0, 'DHouLikResLR (>5%<=10%)': 2.0, 'DHouSafResH (>5%<=10%)': 174.0, 'DHouSafResLR (>10%)': 1.0, 'RHouTiltResH (<=1%)': 3.0, 'RHouTiltResLD (<=1%)': 2.0, 'RHouLeanResH  (>1<=5%)': 13.0, 'RHouLeanResLD  (>1<=5%)': 4.0, 'RHouLikResH (>5%<=10%)': 15.0, 'RHouLikResLD (>5%<=10%)': 5.0, 'RHouSafResH (>10%)': 174.0, 'RHouSafResLD (>10%)': 4.0, 'DSenTiltResH (<=1%)': 1.0, 'DSenTiltResLR (<=1%)': 0.0, 'DSenLeanResH  (>1<=5%)': 1.0, 'DSenLeanResLR  (>1<=5%)': 0.0, 'DSenLikResH (>5%<=10%)': 1.0, 'DSenLikResLR (>5%<=10%)': 0.0, 'DSenSafResH (>10%)': 10.0, 'DSenSafResLR (>10%)': 0.0, 'RSenTiltResH (<=1%)': 1.0, 'RSenTiltResLD (<=1%)': 1.0, 'RSenLeanResH  (>1<=5%)': 1.0, 'RSenLeanResLD  (>1<=5%)': 1.0, 'RSenLikResH (>5%<=10%)': 2.0, 'RSenLikResLD (>5%<=10%)': 0.0, 'RSenSafResH (>10%)': 15.0, 'RSenSafResLD (>10%)': 1.0}
OFFICIAL_BASELINE_HEADLINE = {'D House Seats': 230, 'R House Seats': 205, 'D Senate Seats': 50, 'R Senate Seats': 50}
